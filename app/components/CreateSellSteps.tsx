...
const CreateSellSteps = () => {
  const steps = [
    {
      id: 1,
      image: '/images/box-icon/icon-01.png',
    ...
    {
      id: 2,
      image: '/images/box-icon/icon-02.png',
    ...
    {
      id: 3,
      image: '/images/box-icon/icon-03.png',
      title: 'Add your NFTs',
      description:
    ...
    {
      id: 4,
      image: '/images/box-icon/icon-04.png',
        ...
        <div className='row'>
          ...
          {steps.map((step, index) => (
            <div key={step.id} className='col-lg-3 col-md-6'>
              <div
                className={`tf-box-icon relative text-center ${
                  index === 1 ? 'type-1' : ''
                }`}
              >
                <div className='image'>
                ...
                <h4 className='heading'>
                  <Link href='/contact'>{step.title}</Link>
                </h4>

                <p className='content'>{step.description}</p>

                {step.showArrow && <ArrowIcon />}
              </div>
            </div>
          ))}
        </div>
...
export default CreateSellSteps
